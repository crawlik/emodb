...
public class MultiDCCompactionTest {
    ...
    public void testCorrectCompactionsAreDeleted() {
        ...
        Expanded expand = compactor.expand(record, fctBeforeT2, fctBeforeT2,fctBeforeT2, MutableIntrinsics.create(key), false, requeryFn);
        ...
        expand = compactor.expand(record, fctAfterT2, fctAfterT2, fctBeforeT2, MutableIntrinsics.create(key), false, requeryFn);
